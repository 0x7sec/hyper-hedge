...
print('=== RECENT ETHUSDT ORDERS ===')
orders = session.get_order_history(category='linear', symbol='ETHUSDT', limit=15)['result']['list']
for o in orders:
...
print('\n=== RECENT ETHUSDT CLOSED PNL ===')
pnl = session.get_closed_pnl(category='linear', symbol='ETHUSDT', limit=10)['result']['list']
for p in pnl:
